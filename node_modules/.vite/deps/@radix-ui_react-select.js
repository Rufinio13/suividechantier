...
// node_modules/@radix-ui/react-visually-hidden/node_modules/@radix-ui/react-slot/dist/index.mjs
var $5e63c961fc1ce211$export$8c6ed5c666ac13602 = (0, import_react21.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    const newChildren = childrenArray.map((child) => {
      if (child === slottable) {
        if (import_react21.Children.count(newElement) > 1)
          return import_react21.Children.only(null);
        return (0, import_react21.isValidElement)(newElement) ? newElement.props.children : null;
      } else
        return child;
    });
    return (0, import_react21.createElement)($5e63c961fc1ce211$var$SlotClone2, _extends({}, slotProps, {
      ref: forwardedRef
    }), (0, import_react21.isValidElement)(newElement) ? (0, import_react21.cloneElement)(newElement, void 0, newChildren) : null);
  }
  return (0, import_react21.createElement)($5e63c961fc1ce211$var$SlotClone2, _extends({}, slotProps, {
    ref: forwardedRef
  }), children);
...
var $5e63c961fc1ce211$var$SlotClone2 = (0, import_react21.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  if ((0, import_react21.isValidElement)(children))
    return (0, import_react21.cloneElement)(children, {
  ...
  return import_react21.Children.count(children) > 1 ? import_react21.Children.only(null) : null;
});
$5e63c961fc1ce211$var$SlotClone2.displayName = "SlotClone";
var $5e63c961fc1ce211$export$d9f1ccf0bdb05d452 = ({ children }) => {
  return (0, import_react21.createElement)(import_react21.Fragment, null, children);
};
function $5e63c961fc1ce211$var$isSlottable2(child) {
  return (0, import_react21.isValidElement)(child) && child.type === $5e63c961fc1ce211$export$d9f1ccf0bdb05d452;
}
...
var $8927f6f2acc4f386$export$250ffa63cdc0d0342 = $8927f6f2acc4f386$var$NODES2.reduce((primitive, node) => {
  const Node2 = (0, import_react22.forwardRef)((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? $5e63c961fc1ce211$export$8c6ed5c666ac13602 : node;
    (0, import_react22.useEffect)(() => {
      window[Symbol.for("radix-ui")] = true;
    }, []);
    return (0, import_react22.createElement)(Comp, _extends({}, primitiveProps, {
      ref: forwardedRef
    }));
  });
  Node2.displayName = `Primitive.${node}`;
...
var $ea1ef594cf570d83$export$439d29a4e110a164 = (0, import_react23.forwardRef)((props, forwardedRef) => {
  return (0, import_react23.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d0342.span, _extends({}, props, {
    ref: forwardedRef,
    style: {
...
var $cc7e05a45900e73f$export$c973a4b3cb86a03d = (0, import_react24.forwardRef)((props, forwardedRef) => {
  ...
  if (!context.open) {
    const frag = fragment;
    return frag ? (0, import_react_dom5.createPortal)((0, import_react24.createElement)($cc7e05a45900e73f$var$SelectContentProvider, {
      scope: props.__scopeSelect
